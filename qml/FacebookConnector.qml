...
import VPlay 1.0 // needed for System.IOS

Facebook {

  id: facebook
  appId: "489472511074353" // V-Play Test App 2, created by Chris
...
//        }
    ...
    else if (resultState === Facebook.NoSession) {
  ...
  onOpenWallDialogFinished: {
    console.debug("Facebook: onWallPostFinished: resultState:" + resultState + ", postId:" + postId);
  }
  ...
  function postOpinionToUserWall() {
     facebook.openWallDialog( {
                                    "link" : vplayPageLink,
                                    "name" : "Squaby Feedback",
                                 "message" : "pre-entered text - not working at the moment" } )
