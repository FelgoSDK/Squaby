...
SquabyLevelBase {
  Component.onCompleted: {
    //console.debug("Level02 completed!")
...
//    var entityId = entityManager.createEntityFromUrlWithProperties(Qt.resolvedUrl("../../entities/Obstacle.qml"), { variationType: "teddy", x:100, y: 100, entityId: "teddy1"})
//    var entity = entityManager.getEntityById(entityId)
//    console.debug("___Level02 created entity:", entity, entity.parent, entity.parent.parent)
...
//    entityManager.createEntityFromEntityTypeAndVariationType( {entityType: "obstacle", variationType: "teddy", x:100, y: 100, entityId: "teddy1"} )
  }
